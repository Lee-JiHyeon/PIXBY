...
''' 3. STL 데이터 다운로드(Train set, Test set 분리) - Data Augmentation 적용 (1) 기본 cifar-10 데이터 '''
train_dataset = datasets.STL10(root = "./data/STL_10",
                                 split = 'train',
                                 download = True,
...
test_dataset = datasets.STL10(root = "./data/STL_10",
                                 split = 'test',
                                 transform = transforms.Compose([
                                     transforms.RandomHorizontalFlip(),
                                     transforms.ToTensor(),
